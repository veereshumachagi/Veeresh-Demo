...
WebUI.callTestCase(findTestCase('Day 1/Test_Scriptmode'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Login                Please login to make appointment                                    Login failed Please ensure the username and password are valid'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'HI')
