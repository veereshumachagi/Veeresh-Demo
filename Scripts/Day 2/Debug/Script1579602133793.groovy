...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/form_LOGIN Panel                                                      Username                                                                     Password'))
...
WebUI.waitForElementPresent(findTestObject('Page_OrangeHRM/li_Logout'), 5)
